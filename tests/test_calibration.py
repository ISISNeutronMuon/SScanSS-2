...
class TestCalibration(unittest.TestCase):
    ...
    def testRobotWorldCalibration(self):
        ...
        base_to_end = [np.array([[-0.53170025, -0.20820506, 0.82094187, 67.585304],
        ...
        expected_tool = [[0.91168422, 0.2246568, -0.34403665, -8.85228243],
                         [0.27665157, 0.28345605, 0.9182138, -10.1062245],
                         [0.30380224, -0.9322993, 0.19627075, 5.39666712],
                         [0., 0., 0., 1.]]

        expected_base = [[0.28941257, -0.4618411, -0.83841705, 22.47052877],
