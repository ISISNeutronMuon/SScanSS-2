...
class LockJoint(QtWidgets.QUndoCommand):
    def __init__(self, positioner_name, index, value, presenter):
        ...
        stack = self.model.active_instrument.getPositioner(self.positioner_name)
...
class ChangeJawAperture(QtWidgets.QUndoCommand):
    def __init__(self, aperture, presenter):
        ...
        self.model = presenter.model
        jaws = self.model.active_instrument.jaws
    ...
    def redo(self):
        self.model.active_instrument.jaws.aperture[0] = self.new_aperture[0]
        self.model.active_instrument.jaws.aperture[1] = self.new_aperture[1]
        self.model.instrument_controlled.emit(self.id())

    def undo(self):
        self.model.active_instrument.jaws.aperture[0] = self.old_aperture[0]
        self.model.active_instrument.jaws.aperture[1] = self.old_aperture[1]
        self.model.instrument_controlled.emit(self.id())
