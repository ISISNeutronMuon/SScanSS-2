    ...
    if data_is_dict:
        ...
        if "instrument" in data_keys:
            ...
            if data__instrument_is_dict:
                ...
                if not all(prop in data__instrument for prop in ['name', 'version', 'gauge_volume', 'incident_jaws', 'detectors', 'positioning_stacks', 'positioners']):
                    raise JsonSchemaException("data.instrument must contain ['name', 'version', 'gauge_volume', 'incident_jaws', 'detectors', 'positioning_stacks', 'positioners'] properties", value=data__instrument, name="data.instrument", definition={'type': 'object', 'properties': {'name': {'description': 'The unique name of the instrument', 'type': 'string'}, 'version': {'description': 'The version number of file', 'type': 'string'}, 'script_template': {'description': 'The path of script template', 'type': 'string'}, 'gauge_volume': {'description': 'The centre of gauge volume', 'type': 'array', 'items': {'type': 'number'}, 'minItems': 3, 'maxItems': 3}, 'incident_jaws': {'type': 'object', 'properties': {'aperture': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 2, 'maxItems': 2}, 'aperture_lower_limit': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 2, 'maxItems': 2}, 'aperture_upper_limit': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 2, 'maxItems': 2}, 'beam_direction': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 3, 'maxItems': 3}, 'beam_source': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 3, 'maxItems': 3}, 'positioner': {'type': 'string'}, 'visual': {'$ref': '#/definitions/visual'}}, 'required': ['aperture', 'aperture_lower_limit', 'aperture_upper_limit', 'beam_direction', 'beam_source', 'visual']}, 'detectors': {'type': 'array', 'items': {'$ref': '#/definitions/detector'}, 'minItems': 1}, 'collimators': {'type': 'array', 'items': {'$ref': '#/definitions/collimator'}}, 'positioning_stacks': {'type': 'array', 'items': {'$ref': '#/definitions/positioning_stack'}, 'minItems': 1}, 'positioners': {'type': 'array', 'items': {'$ref': '#/definitions/positioner'}, 'minItems': 1}, 'fixed_hardware': {'type': 'array', 'items': {'$ref': '#/definitions/hardware'}}}, 'required': ['name', 'version', 'gauge_volume', 'incident_jaws', 'detectors', 'positioning_stacks', 'positioners']}, rule='required')
                ...
                if "detectors" in data__instrument_keys:
                    ...
                    if not isinstance(data__instrument__detectors, (list)):
                        raise JsonSchemaException("data.instrument.detectors must be array", value=data__instrument__detectors, name="data.instrument.detectors", definition={'type': 'array', 'items': {'$ref': '#/definitions/detector'}, 'minItems': 1}, rule='type')
                    ...
                    if data__instrument__detectors_is_list:
                        ...
                        if data__instrument__detectors_len < 1:
                            raise JsonSchemaException("data.instrument.detectors must contain at least 1 items", value=data__instrument__detectors, name="data.instrument.detectors", definition={'type': 'array', 'items': {'$ref': '#/definitions/detector'}, 'minItems': 1}, rule='minItems')
                ...
                if "positioning_stacks" in data__instrument_keys:
                    ...
                    if not isinstance(data__instrument__positioningstacks, (list)):
                        raise JsonSchemaException("data.instrument.positioning_stacks must be array", value=data__instrument__positioningstacks, name="data.instrument.positioning_stacks", definition={'type': 'array', 'items': {'$ref': '#/definitions/positioning_stack'}, 'minItems': 1}, rule='type')
                    ...
                    if data__instrument__positioningstacks_is_list:
                        ...
                        if data__instrument__positioningstacks_len < 1:
                            raise JsonSchemaException("data.instrument.positioning_stacks must contain at least 1 items", value=data__instrument__positioningstacks, name="data.instrument.positioning_stacks", definition={'type': 'array', 'items': {'$ref': '#/definitions/positioning_stack'}, 'minItems': 1}, rule='minItems')
                ...
                if "positioners" in data__instrument_keys:
                    ...
                    if not isinstance(data__instrument__positioners, (list)):
                        raise JsonSchemaException("data.instrument.positioners must be array", value=data__instrument__positioners, name="data.instrument.positioners", definition={'type': 'array', 'items': {'$ref': '#/definitions/positioner'}, 'minItems': 1}, rule='type')
                    ...
                    if data__instrument__positioners_is_list:
                        ...
                        if data__instrument__positioners_len < 1:
                            raise JsonSchemaException("data.instrument.positioners must contain at least 1 items", value=data__instrument__positioners, name="data.instrument.positioners", definition={'type': 'array', 'items': {'$ref': '#/definitions/positioner'}, 'minItems': 1}, rule='minItems')
...
def validate___definitions_positioner(data):
    if not isinstance(data, (dict)):
        raise JsonSchemaException("data must be object", value=data, name="data", definition={'$id': '#positioner', 'type': 'object', 'properties': {'name': {'type': 'string'}, 'base': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 6, 'maxItems': 6}, 'tool': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 6, 'maxItems': 6}, 'custom_order': {'type': 'array', 'items': {'type': 'string'}}, 'joints': {'type': 'array', 'items': {'$ref': '#/definitions/joint'}, 'minItems': 1}, 'links': {'type': 'array', 'items': {'$ref': '#/definitions/link'}, 'minItems': 2}}, 'required': ['name', 'joints', 'links']}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['name', 'joints', 'links']):
            raise JsonSchemaException("data must contain ['name', 'joints', 'links'] properties", value=data, name="data", definition={'$id': '#positioner', 'type': 'object', 'properties': {'name': {'type': 'string'}, 'base': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 6, 'maxItems': 6}, 'tool': {'type': 'array', 'items': {'type': 'number'}, 'minItems': 6, 'maxItems': 6}, 'custom_order': {'type': 'array', 'items': {'type': 'string'}}, 'joints': {'type': 'array', 'items': {'$ref': '#/definitions/joint'}, 'minItems': 1}, 'links': {'type': 'array', 'items': {'$ref': '#/definitions/link'}, 'minItems': 2}}, 'required': ['name', 'joints', 'links']}, rule='required')
        data_keys = set(data.keys())
        if "name" in data_keys:
            data_keys.remove("name")
            data__name = data["name"]
        ...
        if "joints" in data_keys:
            ...
            if not isinstance(data__joints, (list)):
                raise JsonSchemaException("data.joints must be array", value=data__joints, name="data.joints", definition={'type': 'array', 'items': {'$ref': '#/definitions/joint'}, 'minItems': 1}, rule='type')
            data__joints_is_list = isinstance(data__joints, list)
            if data__joints_is_list:
                data__joints_len = len(data__joints)
                if data__joints_len < 1:
                    raise JsonSchemaException("data.joints must contain at least 1 items", value=data__joints, name="data.joints", definition={'type': 'array', 'items': {'$ref': '#/definitions/joint'}, 'minItems': 1}, rule='minItems')
        ...
        if "links" in data_keys:
            ...
            if not isinstance(data__links, (list)):
                raise JsonSchemaException("data.links must be array", value=data__links, name="data.links", definition={'type': 'array', 'items': {'$ref': '#/definitions/link'}, 'minItems': 2}, rule='type')
            data__links_is_list = isinstance(data__links, list)
            if data__links_is_list:
                data__links_len = len(data__links)
                if data__links_len < 2:
                    raise JsonSchemaException("data.links must contain at least 2 items", value=data__links, name="data.links", definition={'type': 'array', 'items': {'$ref': '#/definitions/link'}, 'minItems': 2}, rule='minItems')
...
def validate___definitions_positioning_stack(data):
    if not isinstance(data, (dict)):
        raise JsonSchemaException("data must be object", value=data, name="data", definition={'$id': '#positioning_stack', 'type': 'object', 'properties': {'name': {'type': 'string'}, 'positioners': {'type': 'array', 'items': {'type': 'string'}, 'minItems': 1}}, 'required': ['name', 'positioners']}, rule='type')
    data_is_dict = isinstance(data, dict)
    if data_is_dict:
        data_len = len(data)
        if not all(prop in data for prop in ['name', 'positioners']):
            raise JsonSchemaException("data must contain ['name', 'positioners'] properties", value=data, name="data", definition={'$id': '#positioning_stack', 'type': 'object', 'properties': {'name': {'type': 'string'}, 'positioners': {'type': 'array', 'items': {'type': 'string'}, 'minItems': 1}}, 'required': ['name', 'positioners']}, rule='required')
        data_keys = set(data.keys())
        if "name" in data_keys:
            data_keys.remove("name")
            data__name = data["name"]
        ...
        if "positioners" in data_keys:
            ...
            if not isinstance(data__positioners, (list)):
                raise JsonSchemaException("data.positioners must be array", value=data__positioners, name="data.positioners", definition={'type': 'array', 'items': {'type': 'string'}, 'minItems': 1}, rule='type')
            ...
            if data__positioners_is_list:
                ...
                if data__positioners_len < 1:
                    raise JsonSchemaException("data.positioners must contain at least 1 items", value=data__positioners, name="data.positioners", definition={'type': 'array', 'items': {'type': 'string'}, 'minItems': 1}, rule='minItems')
