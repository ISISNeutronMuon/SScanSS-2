...
class InsertPrimitiveDialog(QtWidgets.QWidget):
    ...
    def __init__(self, primitive, parent):
        ...
        self.create_primitive_button = QtWidgets.QPushButton(objectName='GreyTextPushButton')
        self.create_primitive_button.setText('Create')
...
class InsertPointDialog(QtWidgets.QWidget):
    ...
    def __init__(self, point_type, parent):
        ...
        self.form_group.group_validation.connect(self.formValidation)
        button_layout = QtWidgets.QHBoxLayout()
        self.execute_button = QtWidgets.QPushButton(objectName='GreyTextPushButton')
        self.execute_button.setText(self.title)
...
class PickPointDialog(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        self.execute_button = QtWidgets.QPushButton(objectName='GreyTextPushButton')
        self.execute_button.setText('Add Points')
...
class AlignSample(QtWidgets.QWidget):
    ...
    def __init__(self, parent):
        ...
        button_layout = QtWidgets.QHBoxLayout()
        self.execute_button = QtWidgets.QPushButton(objectName='GreyTextPushButton')
        self.execute_button.setText('Align Sample')
        self.execute_button.clicked.connect(self.executeButtonClicked)
        button_layout.addWidget(self.execute_button)
        button_layout.addStretch(1)
        self.main_layout.addLayout(button_layout)
...
class VolumeLoader(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.execute_button = QtWidgets.QPushButton(objectName='WhiteTextPushButton')
        self.execute_button.setText('Load Volume')
        self.execute_button.setDisabled(True)
        self.execute_button.clicked.connect(self.executeButtonClicked)
        cancel_button = QtWidgets.QPushButton(objectName='BlueTextPushButton')
